...
advertisement_data_1 = {'category': 'real-estate/apartments-sale/secondary/', 'region': 'russia/moskva-gorod/', 'advert_type' : 'realty_sell',
...
def test_create_advermission(app_auth):
    advertisement_data_1['auth_token'] = app_auth.auth_token
    ...
    assert data['advertisement']['email'] == app_auth.mail, "Email is incorrect"
